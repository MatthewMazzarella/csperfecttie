...
class HomepagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homepage" do
    assert_difference('Homepage.count') do
      post homepages_url, params: { homepage: { content: @homepage.content, name: @homepage.name, title: @homepage.title } }
    end
  ...
  test "should update homepage" do
    patch homepage_url(@homepage), params: { homepage: { content: @homepage.content, name: @homepage.name, title: @homepage.title } }
